...
# (Uncomment if youÕre on an older Mac that messes up the animation)
...
# Disable ÒnaturalÓ (Lion-style) scrolling
...
# Enable Òfocus follows mouseÓ for Terminal.app and all X11 apps
